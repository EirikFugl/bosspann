...
vinduhøyde = 600 
p.init()
screen = p.display.set_mode((vindubredde, vinduhøyde))
...
def main():
    ...
    while True:
        ...
        if fiende_teller >= 60:
            fiende_gruppe.add(Fiende(r.randint(0,vindubredde),r.randint(0,vinduhøyde),r.randint(10,20)))
            fiende_teller = 0
